...
router.register(r'committee-meetings', views.CommitteeMeetingViewSet)
...
urlpatterns = [
    ...
    url(r'^spider/session/(?P<session>[\d-]+)/committee-meetings/$', views.committee_meeting_spider, {'spider': 'committee_meeting'}),    
    url(r'^spider/session/(?P<session>[\d-]+)/committees/$', views.committee_spider, {'spider': 'committee'}),
    url(r'^spider/session/(?P<session>[\d-]+)/all/$', views.scrape_all),
